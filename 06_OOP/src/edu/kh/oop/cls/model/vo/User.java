...
public class User {
	...
	//자바는 기본적으로 필드명, 생성자명, 메서드명, 변수명의 중복 허용 X
	...
	public User(int userAge, String usesrId) {}
	...
	//2. 이 메서드가 부모 클래스를 재정의했다는 것을 한눈에 알 수 있음
	...
	// toString() 매서드 : Object 최상위 클래스 이미 만들어져있는 메서드
