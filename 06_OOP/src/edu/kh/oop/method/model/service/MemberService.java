...
public class MemberService {
	...
	public void displayMenu() {
		...
		do {
			...
			menuNum = sc.nextInt();
			System.out.println(); //입력 버퍼에 남은 개행문자 제거용
	...
	public String logIn() {
		...
		if(memberInfo == null) { //회원가입을 안한 경우
			...
			//return 값; -> 현재 메서드 종료하고 값을 가지고 해당 메서드를 호출한 쪽으로 되돌아감
		}
	...
	public int updateMember() {
		...
		if(inputPw.equals( loginMember.getMemberPw()) ) {
			//-> 비밀번호가 일치하는 경우, 로그인한 회원의 이름과 나이 정보를 입력받은 값으로
			// 변경 후 1 반환
