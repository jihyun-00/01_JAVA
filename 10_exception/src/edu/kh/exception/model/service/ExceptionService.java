...
public class ExceptionService {
	...
	// 예외는 두 종류로 구분됨
	// 1) Unchecked Exception : 선택적 예외 처리(ex. Runtime Exception)
	// 2) Checked Exception : 필수적 예외 처리(ex. IOException, 나머지)
	
	private Scanner sc = new Scanner(System.in);
	
	public void ex1() {
		//두 정수를 입력받아 나누기 한 몫을 출력
		...
		if(input2 !=0) {
			...
			//intput2에 0이 들어왔을 때 0으로 나눌 수 없다 : 산술적 예외 발생
		...
		//발생하는 예외 중 일부 예외try-catch 사용 안해도
		//if-else 예외 상황 방지 가능
	...
	public void ex2() {
		...
		try {
			...
			System.out.println("타입의 맞는 값만 입력하세요.");
		} catch (ArithmeticException e) {
	...
	public void methodC() throws IOException{
		...
		//throw : 예외 강제 발생 구문
		throw new FileNotFoundException(); //checked Exception이면 빨간줄
	}
	
	public void ex5() throws UserException{
		// 사용자 정의 에외 클래스인 UserException 사용하여 강제 예외 발생시키기
