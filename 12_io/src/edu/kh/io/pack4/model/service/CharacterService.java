...
public class CharacterService {
	...
	/*
	 * 문자 기반 스틂 - 2byte 문자 단위로 입/출력하는 스트림
	 * 
	...
	/**
	 * 문자 기반 파일 입력(파일 읽어오기) + 보조 스트림Buffered 사용
	 */
	public void fileInput() {
		...
		try {
			...
			while (true) {
				...
				// BufferedReader.readLine() : 한줄씩 문자열을 읽는 역할(줄단위)
	...
	/**
	 * 문자 기반 파일 출력(파일 내보내기) +보조 스트림 Buffered 사용
	 */
	public void fileOutput() {

		// 스트림 참조변수 선언
		FileWriter fw = null; // 문자 기반 파일 출력 스트림
		BufferedWriter dw = null; // 문자 출력 보고 스트림
