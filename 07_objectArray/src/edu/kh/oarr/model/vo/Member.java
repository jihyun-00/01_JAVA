...
public class Member {
	...
	private String region; //서울, 경기, 충북, 강원
	...
	//모든 필드 초기화용 매개변수 생성자
	//오버로딩 : 같은 클래스에 동일한 생성자명, 메서드명 등을 이용할 수 있는 기법
	//오버로딩 성립조건 : 매개변수의 개수, 변수, 타입 중 하나라도 달라야한다.
	//						+ 생성자명, 메서드명 같아야 한다.
	...
	// -> getter setter의 접근제한자는 public이어야 한다.
	
	public String getMemberId() {
		// 반환형 : String 자료형인 값을 되돌려줌
		return memberId;
		// return memberId; : 해당 메서드를 종료하고, 호출한 쪽으로 memberId를 가지고 되돌아감
	}
